 ...
 *
 * Il a porte un temps une surface d'eau animee en WebGL. Elle est retiree, a
 * la demande de Clement : elle ne demarrait pas chez lui, et un effet qu'il
 * faut diagnostiquer pour savoir s'il fonctionne coute plus qu'il ne rapporte
 * sur le bouton qui fait entrer dans l'application.
 *
