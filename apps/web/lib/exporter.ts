...
const MENTION: Record<Langue, string> = {
  fr: "Généré par MYP · projet indépendant, non affilié à l'UNIL · seuls le plan d'études et le règlement officiels font foi",
  en: "Generated by MYP · an independent project, not affiliated with UNIL · only the official study plan and regulations are authoritative",
};
